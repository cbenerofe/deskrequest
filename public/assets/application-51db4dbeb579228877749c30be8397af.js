...
/*
 * Cloudinary's jQuery library - v1.0.20
  ...
  (function($) {
    ...
    $.attachinary.Attachinary = (function() {
      function Attachinary($input, config) {
        ...
        this.$submit = this.$form.find((_ref = this.options.submit_selector) != null ? _ref : 'input[type=submit]');
      ...
      Attachinary.prototype.removeFile = function(fileIdToRemove) {
        var file, removedFile, _files, _i, _len, _ref;
        _files = [];
        removedFile = null;
        _ref = this.files;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
